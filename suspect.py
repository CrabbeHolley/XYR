...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.idEdit)
        ...
        self.PIDEdit = QtWidgets.QLineEdit(self.widget)
        self.PIDEdit.setObjectName("PIDEdit")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.PIDEdit)
